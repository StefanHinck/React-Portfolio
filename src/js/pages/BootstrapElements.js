          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div style={marginBottom}>
                <div class="btn-toolbar bs-component" style={marginZero}>
                  <div class="btn-group">
                    <a href="#" class="btn btn-default">Default</a>
            ...
            <div class="col-md-5">
              ...
              <div class="bs-component" style={marginBottom}>
        ...
        <div class="bs-docs-section">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="bs-component">
                <div class="progress">
                  <div class="progress-bar" style={widthTwenty}></div>
                </div>
              </div>
              ...
              <div class="bs-component">
                <div class="progress">
                  <div class="progress-bar progress-bar-info" style={widthTwenty}></div>
                </div>

                <div class="progress">
                  <div class="progress-bar progress-bar-success" style={widthFourty}></div>
                </div>

                <div class="progress">
                  <div class="progress-bar progress-bar-warning" style={widthSixty}></div>
                </div>

                <div class="progress">
                  <div class="progress-bar progress-bar-danger" style={widthEighty}></div>
                </div>
              </div>
              ...
              <div class="bs-component">
                <div class="progress progress-striped active">
                  <div class="progress-bar" style={widthFourty}></div>
                </div>
              </div>
              ...
              <div class="bs-component">
                <div class="progress">
                  <div class="progress-bar progress-bar-success" style={widthThirtyFive}></div>
                  <div class="progress-bar progress-bar-warning" style={widthTwenty}></div>
                  <div class="progress-bar progress-bar-danger" style={widthTen}></div>
                </div>
              </div>
            </div>
          </div>
